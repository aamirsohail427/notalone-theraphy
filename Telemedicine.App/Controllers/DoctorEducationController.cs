...
namespace Telemedicine.App.Controllers
{
    ...
    public class DoctorEducationController : Controller
    {
        ...
        public DoctorEducationController(IDoctorEducationService service, ISessionManager sessionManager)
        {
            _service = service;
        ...
        [HttpPost]
        public async Task<IActionResult> Save(DoctorEducationRequestDto doctorEducationRequestDto)
        {
            return Json(await _service.SaveAsync(_sessionManager.GetUserId(), doctorEducationRequestDto));
        }
        ...
        public async Task<IActionResult> GetAllByUser()
        {
            ...
            return PartialView("~/Views/User/PartialViews/_EducationDetail.cshtml", result.Data);
        }
